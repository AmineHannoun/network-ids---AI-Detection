...
print("=" * 55)
print("   XGBOOST — Détection d'attaques réseau")
print("=" * 55)
...
plt.xlabel('Prédit')
plt.tight_layout()
plt.savefig('reports/figures/confusion_matrix_xgb.png', dpi=150)
print("   Matrice sauvegardée → reports/figures/confusion_matrix_xgb.png")
print("=" * 55)
